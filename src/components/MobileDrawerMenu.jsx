...
import { X, FolderKanban, Plus, Share2, Search, Check } from "lucide-react";
          ...
          <div>
            ...
            <div className="flex gap-2 mt-2.5">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-[#1e3e62]/70 hover:bg-[#1e3e62] text-sky-200 border border-blue-400/30 text-xs font-semibold"
              >
              ...
              <button
                ...
                className="flex items-center justify-center px-3 py-2 rounded-xl bg-sky-500/20 hover:bg-sky-500/30 text-sky-300 border border-sky-400/30 text-xs font-semibold"
